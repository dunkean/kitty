...
export default class CustomProducts extends React.Component {
  ...
  fetchProducts = ({ ids, sku, sort, limit, category_id, tags, attributes, price_from, price_to, on_sale }) => {
    let filter = {
      ...
      price_to: price_to,
      sort: sort,
      fields: 'path,id,name,category_id,category_name,meta_title,weight,sku,images,enabled,discontinued,stock_status,stock_quantity,price,on_sale,regular_price,attributes,tags',
      limit: limit || 4,
      offset: 0
    };
